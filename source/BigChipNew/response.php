...
{   //check $_POST["content_txt"] is not empty
    ...
    $insert_row = $mysqli->query("INSERT INTO `invoices` (invoice_date, invoice_number, vendor, subtotal, pst, gst) VALUES ('$invoice_date_save', '$invoice_number_save', '$vendor_save', '$subtotal_save', '$pst_save', '$gst_save')");
